...
## First-viewport capital route acceptance: 22 September 2026 · final28

The live Silver hero now exposes a compact `CAPITAL ROUTE` directly below the
observed quote endpoints. It is generated by the same deterministic capital
helper as the full decision card, using a clearly labelled $10,000 example.
The blocked case reads `Keep $10,000 uncommitted` and points to the unresolved
identity, unit, issuer and execution checks. The browser verifier confirmed the
