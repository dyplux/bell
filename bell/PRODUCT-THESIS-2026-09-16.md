...
- `DO NOT SHORTLIST`: stop the wrapper selection until the contradiction is
  resolved;
- `INVESTIGATE`: continue research, but keep the
  representations separate;
- `FACTS OPEN`: inspect observed rows when no published rule fired,
